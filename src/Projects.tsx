...
const Blogs = () => {
    return (
        <div className="flex flex-col items-center w-full min-h-screen max-h-screen overflow-y-hidden font-Oxanium" id="projects"> 
            <div className="font-Oxanium text-9xl md:text-7xl">Projects</div>
            {
                data.map((data) => {
                    return (
            ...
            <a className={"text-white rounded-full bg-indigo-500 hover:bg-indigo-700 px-4 py-1.5 duration-200 ease-in-out"}> See More Projects ... </a>
        </div>
    )
}
